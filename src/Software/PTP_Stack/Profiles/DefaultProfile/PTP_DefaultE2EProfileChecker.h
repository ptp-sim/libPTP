...
#ifndef LIBPTP_PTP_DEFAULT_E2E_PROFILE_CHECKER_H_
#define LIBPTP_PTP_DEFAULT_E2E_PROFILE_CHECKER_H_
...
class PTP_DefaultE2EProfileChecker: public PTP_DefaultProfileChecker
{
    private:
